...
### 2. Pop
Remove an item to the end of DDL
```py
class Node:
    def __init__(self, value):
        self.value = value
...
```
### 5. Get
Get an item using an index number from the list
```py
...
```
### 6. Set
Set value to a certain index in the list
```py
class Node:
    def __init__(self, value):
        self.value = value
...
```
### 7. Insert
Insert an item to a specified index
```py
class Node:
    def __init__(self, value):
        self.value = value
